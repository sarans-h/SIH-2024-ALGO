        ...
        <div className='Home'>
            <div className="container">
                <main id='#'>
                    <div className="description" data-aos='fade-up' data-aos-delay="350" >
                        <div className='hero-description'>Top Freelancers And Jobs At Your Fingertips</div>
            ...
            <footer>
                ...
                <p className="footer-body">
                    SkillBridge is a leading provider of freelance services, connecting talented individuals with clients who need their skills and expertise. From website design and development to writing and marketing, our team has the knowledge and experience to help you succeed.
                </p>
                <div className="footer-footer">
                    <div className="copyright">
                        Copyright SkillBridge ©SIH-2024 | All Rights Reserved
                    </div>
