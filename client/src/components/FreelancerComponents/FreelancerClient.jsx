...
import {clientsServices} from '../../Redux/FreelancerSlice'
...
export default function ClientServices() {
  ...
  useEffect(() => {
    dispatch(clientsServices()).unwrap().then(data => {
      console.log(data)
      setTimeout(() => {
  ...
  ? allServices
      .filter(service => service.userInfo.role === "client")  // Filter services where the role is 'client'
      .map(service => (
        <div key={service._id} className="service">
          ...
          <div className="serviceBody">
            ...
            <div className="rating-more">
              ...
              <HashLink to={`/dashboard/freelancer/${id}/servicesby/show/${service._id}`}>
