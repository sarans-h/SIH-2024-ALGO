...
import { getApplied } from '../../Redux/FreelancerSlice';





export default function FreelancerApplied() {
    ...
    useEffect(() => {
        dispatch(getApplied()).unwrap().then(data => {
            setTimeout(() => {
                setLoading(false)
                if (data.status == 200) {
                    setNewData(data.freeApplied)
                }
                        ...
                        <div className="services">
                            {
                                newdata && newdata.length != 0 ? newdata.map(order =>
                                    ...
                                    <div key={order._id} className="service">
                                        ...
                                        <div className="serviceBody">
                                            ...
                                            <div className="rating-more">
                                                ...
                                                <HashLink to={`/dashboard/freelancer/${id}/order/show/${order._id}`}> <button>See More</button></HashLink>
                                            </div>
                                        </div>
                                        <hr />
                                    ...
                                    :
                                    <div className='noServices'>You Didn't Applied to any Work Yet</div>
                            }
                        </div>
                    </div>
                </div>
