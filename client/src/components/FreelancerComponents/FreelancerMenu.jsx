    ...
    return (
        <menu className='Menu'>
            ...
            <div className={active === "jobs" ? 'link active' : 'link'}>
                <NavLink to={`/dashboard/freelancer/${id}/jobs`}>
                    <img src={chat} alt="jobs" />
                    <div className="linkHeader">
                        Jobs
                    </div>
                </NavLink>
            ...
            <div className={active === "applied" ? 'link active' : 'link'}>
                <NavLink to={`/dashboard/freelancer/${id}/applied`}>
                    <img src={services} alt="Jobs" />
                    <div className="linkHeader">
                        Applied Jobs
                    </div>
                </NavLink>
